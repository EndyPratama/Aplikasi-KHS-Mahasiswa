                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="<?= base_url();?>auth/login" method="post">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="<?php echo base_url('Lupa_password') ?>">Forgot Password?</a>
                                    ...
                                    <div class="card-footer text-center py-3">
                                        ...
                                        <div class="small"><a href="<?php echo base_url('C_beranda') ?>">Kembali ke Halaman Utama</a></div></div>
                                    </div>
                                </div>
                            </div>
                        </div>
