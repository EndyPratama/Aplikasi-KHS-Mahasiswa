  ...
  <main>
    <div class="container-fluid px-4">
      ...
      <ol class="breadcrumb mb-4">
        ...
        <li class="breadcrumb-item"><a href="<?php echo base_url('Admin/C_transkrip') ?>">Transkrip Nilai Mahasiswa</a></li>
        ...
        <div class="card card-warning">
          ...
          <div class="card-footer">
            <div class="modal-footer justify-content-between">
              <?php echo anchor('Admin/C_transkrip', '<div class="btn btn-sm btn-danger">Kembali</div>') ?>
            </div>
          </div>
          </form>
        </div>
