                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $mahasiswa->dosen_wali?></td>
                                                ...
                                                <td width="20px"><?php echo anchor('C_mahasiswa/detail/'.$mahasiswa->id_mhs, 
                                                '<div class="btn btn-sm btn-success"><i class="fas fa-eye"></i></div>')?></td>

                                                <td width="20px"><?php echo anchor('C_mahasiswa/update/'.$mahasiswa->id_mhs, 
                                                '<div class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></div>')?></td>

                                                <td width="20px"><?php echo anchor('C_mahasiswa/delete/'.$mahasiswa->id_mhs, 
